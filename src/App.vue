...
console.log(records);
// Pour cours
// le v-if est une directive
// import/export
// directive v for, dupliquer l'élément html autant de fois que l'on veut

const album = ref(records[8]);
const albums = ref(records);
// album est un objet
// album.value est aussi un objet
</script>
...
<div class="min-h-screen flex flex-col">
      ...
      <div class="flex flex-row ">
          ...
          <div class="mt-2 basis-1/4">
              ...
              <div class="overflow-hidden shadow sm:rounded-md">
                  <div class="bg-white p-6 w-64 h-96">
                    ...
                    <ul>
                        <li v-for="(copain,index) in ['Fred','Paul','Claude']">'
                            {{ copain }}
                        </li>
                    </ul>
                  </div>
        ...
        <main class="bg-white py-5 ml-6 basis-auto">
            <!-- component -->
            <section v-for="(album) in albums" class="text-gray-600 body-font"> <!-- boucle ici -->
                <!-- one records -->
